...
function Mainlayout() {
  ...
  let sidebar = navOpen
    ? "sidebar absolute top-0 left-0 w-100 md:w-auto col-span-none md:relative md:block md:col-span-1"
    : "hidden";
    ...
    <div class="layout grid light grid-cols-5 gap-1 w-100">
      ...
      <div className=" grid grid-cols-5 col-span-5">
        <div className={sidebar}>
          <div className="closeBtn flex justify-end  w-100 p-3 text-red-500 fs-10 flex" onClick={()=>setNavOpen(false)}>
          ...
          <div className="menulist list-none pt-20">
            ...
            <NavLink to="/message">
              <li className="menuitem p-2 px-6 flex justify-between">
                ...
                <div className="leftside p-.5 px-3 rounded text-white bg-primary">
                  2
                </div>
              </li>
            </NavLink>
